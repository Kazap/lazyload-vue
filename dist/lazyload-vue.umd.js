(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["lazyload-vue"] = factory();
	else
		root["lazyload-vue"] = factory();
...
const lazyload_es2015_createInstance = function(classObj, options) {
	var event;
...
function autoInitialize(classObj, options) {
	...
	if (!options.length) {
		// Plain object
		lazyload_es2015_createInstance(classObj, options);
	} else {
		// Array of objects
		for (let i = 0, optionsItem; (optionsItem = options[i]); i += 1) {
			lazyload_es2015_createInstance(classObj, optionsItem);
		}
	}
}
...
lazyLoadPlugin.install = function (Vue, options) {
  var createInstance = function createInstance(options) {
    return new lazyload_es2015(options);
  };

  var _ref = options || {},
      _ref$instances = _ref.instances,
      customInstancesOptions = _ref$instances === void 0 ? {} : _ref$instances;

  var defaultRootInstance = {
    elements_selector: ".lazy-image-root"
  };
  customInstancesOptions.root = customInstancesOptions.root || {};
  var instancesOptions = {
    root: _objectSpread({}, defaultRootInstance, customInstancesOptions.root)
  };
  delete customInstancesOptions.root;
  instancesOptions = _objectSpread({}, instancesOptions, customInstancesOptions);

  var instances = entries_default()(instancesOptions).map(function (item) {
    var _item = _slicedToArray(item, 2),
        key = _item[0],
        value = _item[1];

    return _defineProperty({}, key, createInstance(value));
  }).reduce(function (instances, instance) {
    var _Object$entries$ = _slicedToArray(entries_default()(instance)[0], 2),
        key = _Object$entries$[0],
        value = _Object$entries$[1];

    return _objectSpread({}, instances, _defineProperty({}, key, value));
  }, {});
...
//# sourceMappingURL=lazyload-vue.umd.js.map